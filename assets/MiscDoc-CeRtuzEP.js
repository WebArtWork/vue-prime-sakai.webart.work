import{B as $,o as u,c as v,m as l,s as L,O as T,a as i,i as z,Q as B,W as w,az as O,x as M,ae as N,C as U,h as k,w as h,G as C,J as F,H as E,T as G,t as W,b as n,e as J,aV as Q,F as Z,r as ee}from"./index-CJ3188fT.js";import{s as te}from"./index-36OWCtuK.js";import{s as ne}from"./index-Mh8f6w6G.js";import{s as re}from"./index-CwJsFj47.js";import{s as R}from"./index-CRkiUjkj.js";import{a as A}from"./index-CxIyU_SN.js";import{s as ae}from"./index-DU84WF4q.js";var se=`
    .p-skeleton {
        display: block;
        overflow: hidden;
...
`,Ue={root:function(e){var s=e.props;return["p-avatar p-component",{"p-avatar-image":s.image!=null,"p-avatar-circle":s.shape==="circle","p-avatar-lg":s.size==="large","p-avatar-xl":s.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},Ce=$.extend({name:"avatar",style:Te,classes:Ue}),Fe={name:"BaseAvatar",extends:L,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:Ce,provide:function(){return{$pcAvatar:this,$parentInstance:this}}};function S(t){"@babel/helpers - typeof";return S=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},S(t)}function D(t,e,s){return(e=Ee(e))in t?Object.defineProperty(t,e,{value:s,enumerable:!0,configurable:!0,writable:!0}):t[e]=s,t}function Ee(t){var e=Re(t,"string");return S(e)=="symbol"?e:e+""}function Re(t,e){if(S(t)!="object"||!t)return t;var s=t[Symbol.toPrimitive];if(s!==void 0){var o=s.call(t,e);if(S(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var K={name:"Avatar",extends:Fe,inheritAttrs:!1,emits:["error"],methods:{onError:function(e){this.$emit("error",e)}},computed:{dataP:function(){return T(D(D({},this.shape,this.shape),this.size,this.size))}}},Xe=["aria-labelledby","aria-label","data-p"],Ie=["data-p"],Ye=["data-p"],qe=["src","alt","data-p"];function Ke(t,e,s,o,d,r){return u(),v("div",l({class:t.cx("root"),"aria-labelledby":t.ariaLabelledby,"aria-label":t.ariaLabel},t.ptmi("root"),{"data-p":r.dataP}),[z(t.$slots,"default",{},function(){return[t.label?(u(),v("span",l({key:0,class:t.cx("label")},t.ptm("label"),{"data-p":r.dataP}),W(t.label),17,Ie)):t.$slots.icon?(u(),k(F(t.$slots.icon),{key:1,class:C(t.cx("icon"))},null,8,["class"])):t.icon?(u(),v("span",l({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon"),{"data-p":r.dataP}),null,16,Ye)):t.image?(u(),v("img",l({key:3,src:t.image,alt:t.ariaLabel,onError:e[0]||(e[0]=function(){return r.onError&&r.onError.apply(r,arguments)})},t.ptm("image"),{"data-p":r.dataP}),null,16,qe)):E("",!0)]})],16,Xe)}K.render=Ke;var _e=`
    .p-overlaybadge {
        position: relative;
    }
